...
class LoanControllerTest extends BaseControllerTest {
    ...
    void issueLoan_AsLibrarian_Returns201() throws Exception {
        // Added null as 4th argument
        LoanDTO dto = new LoanDTO(1L, 1L, "Student Name", null, 99L, 1L, "C-001",
    ...
    void extendLoan_AsFaculty_Returns200() throws Exception {
        // Added null as 4th argument
        LoanDTO dto = new LoanDTO(1L, 1L, "Faculty Member", null, 99L, 1L, "C-001",
                "Clean Code", LocalDateTime.now(), LocalDate.now().plusDays(30),
    ...
    // ── 13. returnLoan_AsLibrarian_Returns200 ────────────────────────────────
    @Test
    @WithMockUser(roles = "LIBRARIAN")
    ...
    // ── 14. returnLoan_AsStudent_Returns403 ──────────────────────────────────
    @Test
    @WithMockUser(roles = "STUDENT")
    ...
    // ── 15. returnLoan_NotFound_Returns404 ───────────────────────────────────
    @Test
    @WithMockUser(roles = "LIBRARIAN")
